...
export const BudgetPlanner = () => {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      toast({
        title: t("budgetPlanner.failed_to_add_category"),
        variant: "destructive",
      });
    }
  };
  ...
  const handleUpdateCategory = async (
    ...
    try {
      ...
      toast({
        title: t("budgetPlanner.failed_to_update_category"),
        variant: "destructive",
      });
    }
  };
  ...
  const handleDeleteCategory = async (id: string) => {
    ...
    try {
      ...
      toast({
        title: t("budgetPlanner.failed_to_delete_category"),
        variant: "destructive",
      });
    }
  };
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-green-50 dark:bg-gray-800 p-4 rounded-lg space-y-3">
            <h3 className="font-medium text-gray-700 dark:text-gray-100">
              {t("budgetPlanner.add_new_category")}
            </h3>
                      ...
                      <Button
                        onClick={async () => {
                          if (
                            ...
                            toast({
                              title: t(
                                "budgetPlanner.enter_valid_name_and_amount"
                              ),
                              variant: "destructive",
                            });
                            return;
          ...
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
            <div className="flex justify-between items-center">
              <span className="font-medium text-gray-700 dark:text-gray-100">
                {t("budgetPlanner.total_monthly_budget")}
              </span>
